...
To maintain clean build contexts, each vehicle variant has its own isolated directory containing its specific `Containerfile`, systemd service, and startup script.
